...
public class RestTemplateControllerExample {
	...
	public List<PostJSON> getPosts() {
		...
		ResponseEntity<PostJSON[]> response = restTemplate.getForEntity("http://jsonplaceholder.typicode.com/posts",
				PostJSON[].class);
	...
	public PostJSON getPostByID(@PathVariable(value = "postId") String postId) {

		// JSON http://jsonplaceholder.typicode.com/posts/postId
		ResponseEntity<PostJSON> response = restTemplate
				.getForEntity("http://jsonplaceholder.typicode.com/posts/{postId}", PostJSON.class, postId);
	 ...
	 * 
	 * @ResponseStatus(value = HttpStatus.OK) public void savePost(@RequestBody
	 * PostJSON postJSON) {
	 * 
